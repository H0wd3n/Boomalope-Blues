...
# Requirements
 - First off you need to own Rimworld on Steam and preferably all the dlc's (Royalty, Ideology, Biotech, and Anomaly). If you don't own all of the dlc you will need to go through the list and disable any mod that is dlc specific.
 - Rimworld also needs to be updated to the latest 1.5.4243 version (as long as you are not opted into a beta you will be fine).
