...
# Requirements
 - First off you need to own Rimworld on Steam and preferably all the dlc's (Royalty, Ideology, Biotech, and Anomaly). If you don't own all of them I will provide instructions on what mods need to be disabled later.
